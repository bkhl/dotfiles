...
- Steve Purcell's [[https://github.com/purcell/emacs.d][emacs.d]].
...
The configuration is organized so that basic configuration of Emacs are loaded first, then built-in packages that are bundles with Emacs, followed by the add-on packages that are kept in [[https://github.com/bkhl/dotfiles/tree/main/.emacs.d/site-lisp][~/.emacs.d/site-lisp/]].

Here is [[https://www.emacswiki.org/emacs/bkhl][my home page on EmacsWiki]].

Work in progress: moving the below into the appropriate ~.el~ files.
