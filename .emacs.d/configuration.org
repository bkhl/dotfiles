...
~use-package~ is used to configure the add-on packages below.
...
** Interface
*** [[file:site-lisp/minions][minions]] mode line minor mode listing improvments
...
(use-package orderless
  ...
  (add-hook 'minibuffer-setup-hook
            (defun bkhl/minibuffer-setup-hook ()
