...
*** Show multiple messages together in minibuffer

Accumulate messages coming in quick succession and show them together in the minibuffer.

#+begin_src emacs-lisp
(customize-set-variable 'set-message-functions '(set-multi-message))
#+end_src
