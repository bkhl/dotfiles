...
(set-face-attribute 'default
                    nil :family "Courier Prime Code" :height 120)
(set-face-attribute 'variable-pitch
                    nil :family "Vollkorn" :height 1.1)
(set-face-attribute 'fixed-pitch
                    nil :family "Courier Prime Code" :height 1.0)
#+end_src
...
Packages for activating Python virtual environments.

#+begin_src emacs-lisp
(use-package pyvenv)
#+end_src

Define formatters for isort and Black, and define a shortcut for them.
