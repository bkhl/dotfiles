...
(use-package magit
  ...
  (transient-append-suffix 'magit-push "-m"
    '(4
      ...
      "--push-option=merge_request.create --push-option=merge_request.target="))
  (transient-append-suffix 'magit-push "-M"
    '(4
      "-l"
      "Set all tests label"
      "--push-option=merge_request.unlabel=test::skip --push-option=merge_request.label=test::all"))
  (transient-append-suffix 'magit-push "-l"
    '(4
      "-L"
      "Set skip tests label"
      "--push-option=merge_request.unlabel=test::all --push-option=merge_request.label=test::skip")))
#+end_src
