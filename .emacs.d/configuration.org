...
:PROPERTIES:
:CUSTOM_ID: emacsclient-frame-focus
:END:
...
(use-package fontaine
  :custom
  (fontaine-presets
   '((serif :default-family "Iosevka BKHL Serif Normal"
            :variable-pitch-family "Charis SIL"
            :fixed-pitch-family "Iosevka BKHL Serif Normal")
     (sans-serif :default-family "Iosevka BKHL Sans Normal"
     ...
     (t :default-height 130
        ...
        :mode-line-active-family "Iosevka BKHL Sans Normal"
        :mode-line-inactive-family "Iosevka BKHL Sans Normal"))))

(fontaine-set-preset 'sans-serif)
#+end_src
...
*** [[https://magit.vc/][magit]] Git integration
:PROPERTIES:
:CUSTOM_ID: magit
:END:
...
*** [[https://github.com/dgutov/diff-hl][diff-hl]] to show uncommited changes in gutter
:PROPERTIES:
:CUSTOM_ID: diff-hl
:END:
...
*** [[https://git.sr.ht/~bkhl/ob-jira][ob-jira]] Babel support for Jira JQL queries
:PROPERTIES:
:CUSTOM_ID: ob-jira
:END:
