...
Consult expects your package manager to generate some autoloads. Since I don't use one, I set those up here first.
...
(use-package consult-compile
  :commands consult-compile-error)
...
Loading the Consult package itself.
